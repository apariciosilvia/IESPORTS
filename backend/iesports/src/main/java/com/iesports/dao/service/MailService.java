...
public class MailService {
	...
	public void sendMailForgotPassword(String toEmail, String code, String userName) {
	    ...
	    try {
	        ...
	        String htmlContent = "<html>\n" +
	            ...
	            "          <a href=\"http://localhost:5173/login\" style=\"background-color: #ff0800; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block;\">Iniciar sesión</a>\n" +
	            "        </div>\n" +
	            "      </div>\n" +
	            "      <!-- Pie -->\n" +
	...
	public void sendWelcomeEmail(String toEmail, String userName) {
	    ...
	    try {
	        ...
	        String htmlContent = "<!DOCTYPE html>\n" +
	            ...
	            "                            </ul>\n" +
	            "                            <div style=\"text-align:center;margin:30px 0;\">\n" +
	            "                                <a href=\"http://localhost:5173/\" style=\"background-color:#ff0800;color:#ffffff;padding:12px 24px;text-decoration:none;font-weight:bold;border-radius:5px;\">Iniciar sesión</a>\n" +
	            "                            </div>\n" +
	            "                        </td>\n" +
	            "                    </tr>\n" +
	            "                    <tr>\n" +
    ...
    public void sendAdminRegistrationEmail(Person person, String passwordTemp) {
        ...
        try {
            ...
            String htmlContent = "<!DOCTYPE html>\n" +
            		...
            		"                            </ul>\n" +
            		"                            <div style=\"text-align:center;margin:30px 0;\">\n" +
            		"                                <a href=\"http://localhost:5173/login\" style=\"background-color:#ff0800;color:#ffffff;padding:12px 24px;text-decoration:none;font-weight:bold;border-radius:5px;\">Iniciar sesión</a>\n" +
            		"                            </div>\n" +
            		"                        </td>\n" +
            		"                    </tr>\n" +
            		"                    <tr>\n" +
    ...
    @Async
	public void sendMatchVictoryEmail(Person person, Match match) {
	    MimeMessage mimeMessage = mailSender.createMimeMessage();
	
	    try {
	        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
	        helper.setTo(person.getEmail());
	        helper.setSubject("¡Enhorabuena " + person.getName() + "!");
	        ...
	        Team myTeam;
	        Team opponentTeam;
	        if (match.getTeam1().getPlayers().contains(person)) {
	            myTeam = match.getTeam1();
	            opponentTeam = match.getTeam2();
	        } else if (match.getTeam2().getPlayers().contains(person)) {
	            myTeam = match.getTeam2();
	            opponentTeam = match.getTeam1();
	        } else {
	            return; // El jugador no pertenece al partido
	        }
	
	        StringBuilder opponentPlayersList = new StringBuilder();
	        for (Person p : opponentTeam.getPlayers()) {
	            opponentPlayersList.append("<li>").append(p.getName()).append("</li>");
	        }
	        ...
	        String htmlContent = "<!DOCTYPE html>\n" +
	            ...
	            "<head>\n" +
	            "    <meta charset=\"UTF-8\">\n" +
	            "    <title>¡Tu equipo ha pasado de ronda!</title>\n" +
	            "</head>\n" +
	            "<body style=\"margin:0;padding:0;background-color:#f4f4f4;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;\">\n" +
	            "    <table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color:#f4f4f4;padding:40px 0;\">\n" +
	            "        <tr>\n" +
	            ...
	            "                    <tr>\n" +
	            "                        <td style=\"background-color:#002f3d;padding:30px;text-align:center;\">\n" +
	            "                            <h1 style=\"color:#ffffff;margin:0;font-size:24px;\">¡Felicidades <span style=\"color:#ff0800;\">" + person.getName() + "</span>!</h1>\n" +
	            "                        </td>\n" +
	            "                    </tr>\n" +
	            "                    <tr>\n" +
	            "                        <td style=\"text-align:center;padding:20px;\">\n" +
	            ...
	            "                    <tr>\n" +
	            "                        <td style=\"padding:0 40px 30px 40px;text-align:left;\">\n" +
	            "                            <p style=\"font-size:16px;color:#333;\">Tu equipo <b style=\"color:#ff0800;\">" + myTeam.getName() + "</b> ha pasado a la ronda <b style=\"color:#ff0800;\">" + match.getRound() + "</b> del torneo <b>" + match.getTournament().getName() + "</b>.</p>\n" +
	            "                            <p style=\"font-size:16px;color:#333;\">Tu próximo rival será el equipo <b>" + opponentTeam.getName() + "</b>, cuyos jugadores son:</p>\n" +
	            "                            <ul style=\"font-size:16px;color:#333;\">" + opponentPlayersList + "</ul>\n" +
	            "                            <p style=\"font-size:16px;color:#333;\"><b>Fecha del partido:</b> Aún no está definida.</p>\n" +
	            "                            <div style=\"text-align:center;margin:30px 0;\">\n" +
	            "                                <a href=\"http://localhost:5173/tournaments\" style=\"background-color:#ff0800;color:#ffffff;padding:12px 24px;text-decoration:none;font-weight:bold;border-radius:5px;\">Ver torneo</a>\n" +
	            "                            </div>\n" +
	            "                        </td>\n" +
	            "                    </tr>\n" +
	            "                    <tr>\n" +
    ...
    @Async
    public void sendAddedToTeamEmail(Person person, Team team) {
        MimeMessage mimeMessage = mailSender.createMimeMessage();

        try {
            MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
            helper.setTo(person.getEmail());
            helper.setSubject("¡Has sido añadido al equipo " + team.getName() + "!");
            ...
            for (Person p : team.getPlayers()) {
                membersList.append("<li>").append(p.getName()).append("</li>");
            }
            ...
            String htmlContent = "<!DOCTYPE html>\n" +
                ...
                "                    <tr>\n" +
                "                        <td style=\"background-color:#002f3d;padding:30px;text-align:center;\">\n" +
                "                            <h1 style=\"color:#ffffff;margin:0;font-size:24px;\">¡Bienvenido al equipo!</h1>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td style=\"text-align:center;padding:20px;\">\n" +
                ...
                "                        <td style=\"padding:0 40px 30px 40px;text-align:left;\">\n" +
                "                            <p style=\"font-size:16px;color:#333;\">Hola <b style=\"color:#ff0800;\">" + person.getName() + "</b>,</p>\n" +
                "                            <p style=\"font-size:16px;color:#333;\">Has sido añadido al equipo <b style=\"color:#ff0800;\">" + team.getName() + "</b>.</p>\n" +
                "                            <p style=\"font-size:16px;color:#333;\">Estos son tus compañeros de equipo:</p>\n" +
                "                            <ul style=\"font-size:16px;color:#333;\">" + membersList + "</ul>\n" +
                "                            <div style=\"text-align:center;margin:30px 0;\">\n" +
                "                                <a href=\"http://localhost:5173/teams\" style=\"background-color:#ff0800;color:#ffffff;padding:12px 24px;text-decoration:none;font-weight:bold;border-radius:5px;\">Ver tu equipo</a>\n" +
                "                            </div>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
